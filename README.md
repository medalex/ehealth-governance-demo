...
| D4 | Lab Policy (eGFR) | S10 | 1. Open the Lab service on port **3009**.<br>2. Update Emily’s eGFR value to **5**.<br>3. Wait ~30 seconds for synchronization.<br>4. Return to the Hospital portal.<br>5. Attempt to prescribe **Metformin**. | ✗ FAIL → “eGFR 5 < 30” |
